...
function buildUpdateMutation(
  ...
  const mutation: GraphQLFieldConfig<unknown, TUserContext>  = {
    ...
    resolve: async (parent, rawargs, ctx, info) => {
      ...
      const { query, context: newContext } = await executeHook(table, 'update', 'beforeSendQuery', { user, args, query: rawquery, context }, funfunz)
...
function buildAddMutation(
  ...
  const mutation: GraphQLFieldConfig<unknown, TUserContext>  = {
    ...
    resolve: async (parent, rawargs, ctx, info) => {
      ...
      const { query, context: newContext } = await executeHook(table, 'add', 'beforeSendQuery', { user, args, query: rawquery, context }, funfunz)
...
function buildDeleteMutation(
  ...
  const mutation: GraphQLFieldConfig<unknown, TUserContext>  = {
    ...
    resolve: async (parent, rawargs, ctx) => {
      ...
      const { query, context: newContext } = await executeHook(table, 'delete', 'beforeSendQuery', { user, args, query: rawquery, context }, funfunz)
